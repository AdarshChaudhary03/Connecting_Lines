...
public class Survival_Page extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView tv1, tv2, tv3, tv4, tv5, tv6, tv7, tv8, tv9, tv10, tv11, tv12, tv13, tv14, tv15, tv16, tv17, tv18, tv19, tv20, score1, score2,score3,score4,clock;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survival__page);
    ...
    private void countdown() {
        CountDownTimer countdowntimer = new CountDownTimer(100000,1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                if(clock.getText().toString().equalsIgnoreCase("80"))
                {
                    removeplayer();
                }
    ...
    private void startrotate() {
        ...
        rotation = AnimationUtils.loadAnimation(Survival_Page.this,R.anim.rotate);
